...
import com.app.aplikasiku.moviexfavorite.Activity.DetailFavoritTvShowActivity;
...
public class rcFavoriteTvShow extends RecyclerView.Adapter<rcFavoriteTvShow.ViewHolder> {
    ...
    public rcFavoriteTvShow(Cursor data, Context context) {
    ...
    public void onBindViewHolder(rcFavoriteTvShow.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                masuk.putExtra(DetailFavoritTvShowActivity.EXTRA_ID,favorite.getId());
                masuk.setData(uri);
