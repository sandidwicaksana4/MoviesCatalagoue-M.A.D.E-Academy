...
public class DetailFavoritTvShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_favorit_tvshow);
        ...
        tvID = getIntent().getIntExtra(EXTRA_ID,tvID);
        loadSQLite();
    ...
    private void loadSQLite(){
        ...
        if (cursor != null) {
            ...
            if (cursor.moveToFirst()) {
                favorit = new DataFavorite(cursor);
                ...
                txtepisode.setText(favorit.getEpisode());
                txtseason.setText(favorit.getSeason());
